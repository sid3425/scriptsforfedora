...
**Note:** These scripts will work just fine on Fedora Workstation or a Workstation spin or a fork like Nobara, however they will MAY NOT work as intended on a Distrobox/Podman/Docker/WSL container and __DEFINITELY NOT ON FEDORA ATOMIC__. Also, if they in any way cause your system to act weird or cause something like an alien invasion somehow, I will not be responsible at all.
